<?php
	...
	*/
	...
	{		
		$result = $ovAdminManagement->DeleteAdmin($admin_id);
		header("Location: /ov-admin/admins");
		exit();
	}
	else if ($ovAdminSecurity->IsAdminLoggedIn() && !$ovAdminSecurity->CanAccessAdmins())
	{
	...
	{
		header("Location: /ov-admin/login?redirecturl=/ov-admin/admins");
		exit;
	}
?>