<?php
	...
	*/
	...
	{
		$ovAdminReporting->IgnoreReport($report_id);
		$ovAdminContent->DeleteComment($comment_id);

		header("Location: /ov-admin/reports?type=comment");
		exit();
	}
	...
	{
		header("Location: /ov-admin/login?redirecturl=" . urlencode("/ov-admin/reports?type=comment"));
		exit();
	}
?>