...
*/
?>
<h1>Banned User IP Addresses</h1>
	...
	<table width="710" border="0" cellspacing="0" cellpadding="0" class="grid_table">
		<thead>
			<tr>
				...
				<th width="485">Associated With</th>
				<th width="75">&nbsp;</th>
			</tr>
		</thead>
		<tbody>
			<?php foreach ($ban_list as $ban) { ?>
				<tr>
					...
					<td><?php echo $ban['users']; ?></td>
					<td><img src="/ov-admin/img/icons/delete.png" alt="">&nbsp;<a href="/ov-admin/php/unban.php?type=ip&amp;id=<?php echo $ban['ip_address']; ?>" title="Unban">Unban</a></td>
				</tr>
			<?php } ?>
		</tbody>
	</table>
